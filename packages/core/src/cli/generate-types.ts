...
/*
  ...
  Improved: resolves references for non-color categories (fontSize, spacing, etc.)
*/
...
/**
 * Try to find the category bucket in theme using a set of candidate keys:
 * - exact category (e.g. 'fontSize')
 * - category + 's' (e.g. 'fontSizes')
 * - category without trailing 's' (e.g. 'fontSize' if 'fontSizes' passed)
 */
